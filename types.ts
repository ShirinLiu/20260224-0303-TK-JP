...
export interface ItineraryItem {
  ...
  // New Enhanced Fields
  navLink?: string; // Specific URL for navigation (e.g. Naver Map short link)
  referenceLink?: { // External guide link (e.g. Xiaohongshu)
    url: string;
    label: string;
  };
  mapType?: 'google' | 'naver'; // Explicitly force a map provider
  ...
  // Nested Items (e.g., Shopping stops within a shopping block)
