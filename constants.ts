  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        date: "3/2 (一)",
        type: EventType.FOOD,
        title: "Jojo Kalguksu (午餐)",
        startLocation: "Seongsu Stn.",
        endLocation: "Jojo Kalguksu Seongsu",
        startTime: "11:00",
        endTime: "12:00",
        navLink: "https://naver.me/xD8idXR8",
        mapType: 'naver',
        notes: "人氣排隊名店「Jojo刀削麵」。必點：東竹蛤蜊刀削麵、海鮮煎餅。\n地址: 首尔特别市 城东区 圣水洞二街 289-257",
        tags: [{ label: "必吃刀削麵", type: "food" }, { label: "海鮮煎餅", type: "food" }],
        guideRecommendation: {
            mustOrder: "東竹蛤蜊刀削麵 (Dongjuk Kalguksu), 落吉海鮮煎餅 (Nakji Haemul Pajeon)",
            tips: "海鮮煎餅料多實在，幾乎每桌必點。蛤蜊湯頭非常鮮甜。醬料有辣與不辣可選。"
        }
      },
      {
        id: id(),
        ...
        type: EventType.SHOPPING,
        title: "聖水洞逛街攻略 (午後路線)",
        startLocation: "Jojo Kalguksu",
        endLocation: "Gentle Monster",
        startTime: "12:10",
        endTime: "18:40",
        mapType: 'naver',
        notes: "午餐後從餐廳出發，順路逛完聖水洞精華區。中間安排了 Gelato 休息。",
        tags: [{ label: "順路攻略", type: "shopping" }, { label: "12個站點", type: "info" }],
        ...
        subItems: [
            ...
            },
            {
                ...
                date: "3/2 (一)",
                type: EventType.FOOD,
                title: "5. Maman Gelato (甜點休息)",
                startLocation: "Stand Oil",
                endLocation: "Maman Gelato",
                startTime: "14:35",
                endTime: "15:00",
                navLink: "https://naver.me/xfYR1YzE",
                mapType: 'naver',
                notes: "逛累了嗎？來杯清爽的 Gelato 休息一下。",
                tags: [{ label: "Gelato", type: "food" }, { label: "休息站", type: "info" }],
                guideRecommendation: {
                    mustOrder: "Salted Caramel (鹽焦糖), Rice (米)",
                    tips: "店內座位不多，適合稍微休息後繼續戰鬥。"
                }
            },
            {
                id: id(),
                date: "3/2 (一)",
                type: EventType.SHOPPING,
                title: "6. 29CM Seongsu",
                startLocation: "Maman Gelato",
            ...
            },
            {
                ...
                date: "3/2 (一)",
                type: EventType.SHOPPING,
                title: "12. Gentle Monster Haus Nowhere",
                startLocation: "Shiro",
                endLocation: "Gentle Monster",
                startTime: "18:00",
                endTime: "18:40",
